...
enum client_command
{
    ...
    CLIENT_SELECT_CHANGE_CARDS_REQ  = 1030, //选牌后，发送。
    CLIENT_SELECT_LACK_SUIT_REQ     = 1031, //选缺后，发送。
};
...
enum server_command
{
    ...
    SERVER_SELECT_CHANGE_CARDS_START_UC = 4079, //选择换牌
    SERVER_SELECT_CHANGE_CARDS_END_SUCC_UC = 4080,//换牌完成
    SERVER_SELECT_LACK_SUIT_START_UC = 4081, //选择缺一门
